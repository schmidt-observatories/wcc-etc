...
replace_in_cell(d, 8, "snr_60 = simu.get_snr(time=60)", 'snr_60 = simu.get_snr(time=60)["snr"]')
replace_in_cell(d, 8, "snr_curve = simu.get_snr(time=times)", 'snr_curve = simu.get_snr(time=times)["snr"]')
replace_in_cell(d, 10, "snr_before = float(simu.get_snr(60))", 'snr_before = float(simu.get_snr(60)["snr"])')
replace_in_cell(d, 10, "snr_after = float(simu.get_snr(60))", 'snr_after = float(simu.get_snr(60)["snr"])')
...
replace_in_cell(d, 4, "print(f'get_snr(t)        = {snr_back:.4f}')",
...
replace_in_cell(d, 13, "snr_hot = sim.get_snr(60).value", 'snr_hot = sim.get_snr(60)["snr"]')
replace_in_cell(d, 13, "snr_cool = sim.get_snr(60).value", 'snr_cool = sim.get_snr(60)["snr"]')
