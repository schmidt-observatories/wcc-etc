...
class TestPSFUtilities:
    def test_normalize_sums_to_one_and_clips_negatives(self):
    ...
    def test_center_crop_or_pad_crops_preserving_center(self):
        a = np.zeros((5, 5))
        a[2, 2] = 1.0
    ...
    def test_center_crop_or_pad_pads_to_size(self):
        a = np.zeros((3, 3))
        a[1, 1] = 1.0
    ...
    def test_center_crop_or_pad_even_source_to_odd_output(self):
        a = np.zeros((6, 6))
        a[3, 3] = 1.0
        out = center_crop_or_pad(a, 5)
        assert out.shape == (5, 5)
    ...
    def test_load_huygens_psf_shape_and_finite(self):
    ...
    def test_load_huygens_psf_second_file(self):
    ...
    def test_detector_context_defaults(self):
...
class TestPSFSource:
    ...
    def test_airy_render_shape_normalized_centered(self):
    ...
    def test_airy_recenter_shifts_peak(self):
    ...
    def test_custom_psf_from_array(self):
        arr = np.zeros((51, 51))
        arr[25, 25] = 1.0
...
class TestDefocusPSF:
    def test_render_normalized_shape(self):
...
class TestSolveTimeForSnr:
    ...
    def test_array_and_zero_signal(self):
        from wcc_etc.psfsim import solve_time_for_snr
    ...
    def test_aperture_time_for_snr_n_reads_scaling(self):
