...
class TestImagePlotting:
    def test_resolve_inputs_from_simimg(self):
        s = _make_simimg()
    ...
    def test_resolve_inputs_from_arrays(self):
    ...
    def test_plot_image_mpl_returns_fig_ax(self):
    ...
    def test_row_mpl_three_axes(self):
        s = _make_simimg()
    ...
    def test_row_mpl_panel_data(self):
        s = _make_simimg()
        fig, axes = plotting.plot_image_row_mpl(s, stretch="linear")
...
class TestRadialPlotting:
    def test_radial_mpl_returns_fig_ax_and_decreasing(self):
        s = _gaussian_simimg()
    ...
    def test_ee_mpl_monotonic_to_one(self):
        s = _gaussian_simimg()
    ...
    def test_ee_mpl_none_disables_marker(self):
        s = _gaussian_simimg()
        fig, ax, (r, ee) = plotting.plot_encircled_energy_mpl(
...
class TestBokehPlotting:
    def test_plot_image_bokeh_returns_obj_html_components(self):
    ...
    def test_plot_image_row_bokeh(self):
    ...
    def test_plot_radial_bokeh(self):
        from bokeh.models import Plot
...
class TestStyle:
    def test_simimg_method_dispatch_mpl(self):
        s = _gaussian_simimg()
    ...
    def test_simimg_method_dispatch_bokeh(self):
        from bokeh.models import Plot
    ...
    def test_simimg_plot_ee_marks_90_percent_by_default(self):
        s = _gaussian_simimg()
    ...
    def test_set_wcc_style_updates_rcparams(self):
    ...
    def test_image_plots_disable_grid(self):
        import matplotlib as mpl
    ...
    def test_oned_plots_have_faint_gridlines(self):
        s = _gaussian_simimg()
