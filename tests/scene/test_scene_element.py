...
class TestPicklesSpectrum:
    def test_name_aliases_resolve_to_same_spectrum(self):
...
class TestBlackbodySource:
    ...
    def test_update_teff_rebuilds_spectrum(self):
...
class TestFlatSource:
    def test_flat_fnu_is_constant_and_roundtrips_mag(self):
        se = SceneElement.from_config(
    ...
    def test_update_flat_unit_rebuilds_spectrum(self):
...
class TestFileSource:
    ...
    def test_update_source_file_rebuilds_spectrum(self, tmp_path):
        f1 = tmp_path / "s1.dat"
        f2 = tmp_path / "s2.dat"
...
class TestMagnitudeSystem:
    def test_resolve_magsys_aliases_case_insensitive(self):
    ...
    def test_default_magsys_is_vegamag(self):
        import wcc_etc
...
class TestMutableParameters:
    def test_type_specific_and_lock_the_type(self):
        bb = SceneElement.from_config(
            {"spectrum": "blackbody", "teff": 5777, "mag": 15, "bandpass": "johnson_v"}
        )
        pl = SceneElement.from_config(
    ...
    def test_cannot_update_spectrum_type(self, recwarn):
        bb = SceneElement.from_config(
            {"spectrum": "blackbody", "teff": 5777, "mag": 15, "bandpass": "johnson_v"}
        )
